...
const defaultCategories = [
  ...
  { id: 'vds', name: 'VDS服务器', path: '/vds', isMainNav: false, order: 7 },
  { id: 'free', name: '免费VPS', path: '/free', isMainNav: false, order: 8 },
...
const store = createStore({
  state() {
    ...
    return {
      ...
      // VPS数据
      monthlyUnder2Deals: [...vpsDealsData.monthlyUnder2Deals],
      annualUnder15Deals: [...vpsDealsData.annualUnder15Deals],
      annualUnder25Deals: [...vpsDealsData.annualUnder25Deals],
      natOpenVZDeals: [...vpsDealsData.natOpenVZDeals],
      highSpecDeals: [...vpsDealsData.highSpecDeals],
      storageDeals: [...vpsDealsData.storageDeals],
      dedicatedDeals: [...vpsDealsData.dedicatedDeals],
      // 用户留言数据
